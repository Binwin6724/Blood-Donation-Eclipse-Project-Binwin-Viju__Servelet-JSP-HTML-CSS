...
<body>
    ...
    <div class="login-form">
      <div class="text">
DONOR REGISTRATION</div>
				<form name="form" action="databaseinsert" >
          ...
          <div class="fas fa-envelope">
							...
							<input type="text"  placeholder="Blood Group"  id="Bgroup"
							name="Bgroup" class="form-control"><br><br></div>
          ...
          <div class="fas fa-envelope">
                    ...
                    <br>
						...
						<span class="create">Already a Member!<br><a href="donorLogin.jsp">Login Here</a></span>
